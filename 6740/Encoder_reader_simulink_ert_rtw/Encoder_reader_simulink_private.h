...
extern void Encoder_reade_WrapAroundX1_Init(DW_WrapAroundX1_Encoder_reade_T
  *localDW);
extern void Encoder_reader_sim_WrapAroundX1(real_T rtu_input, boolean_T
  rtu_reset, real_T *rty_out, DW_WrapAroundX1_Encoder_reade_T *localDW);
